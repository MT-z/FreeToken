...
def _as_last_data(batch):
    # ForwardOutput itself, not a bare 3-tuple: it grew optional logprobs fields, so the
    # scheduler reads it by name and a positional stub no longer stands in for it.
