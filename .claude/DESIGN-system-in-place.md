...
```
1件ごと（生成込み、60本）  中央値 1.92倍  四分位 1.00–4.69倍
                      本数   合計比
文脈   0k– 40k        14本   1.77倍   ← いちばん薄い
文脈  40k– 80k         3本   2.77倍
文脈  80k–120k        29本   2.58倍
文脈 120k–            14本   2.11倍
```
...
```
得るもの: 生成込みで 1,119 → 487 秒（2.30倍）。1件ごとの中央値 1.92倍
...
| 帯の表 | 比の中央値 2.11/1.99/2.27/1.57 →「長いほど頭打ち」 | **合計比 1.77/2.77/2.58/2.11。傾向は逆**で、薄いのは短文脈 |
