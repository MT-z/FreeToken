...
class Qwen3_5MoEForCausalLM(BaseLLMModel):
    def __init__(self, config: ModelConfig):
        ...
        # #418 made ParallelLMHead quant-aware, so it selects the NVFP4 W4A16 kernel from
        # quant_config -- the Nvfp4LMHead special case (and its ~1 GB bf16 dequant) is gone.
