...
async def handle_chat_completion(
    ...
    # pr224 は logit_bias も拒否していたが、#393 がこのルートで実装済みなので落とす
...
def _completion_unsupported_reason(req: CompletionRequest) -> str | None:
    ...
    # echo / suffix / logit_bias は #393 が実装済みなので、pr224 の拒否は落とす。
    # echo+logprobs だけは completion_logprobs_error が正しく断る（prefill logits が要る）
