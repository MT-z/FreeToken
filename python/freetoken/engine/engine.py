...
def _adjust_config(config: EngineConfig):
    ...
    if is_moe and config.moe_strategy == "auto":
        ...
        # unified memory (GB10) resolves auto to fused upstream (#445); the benchbw verdict only
        # applies where offload was the default.
        if default_backend == "offload" and not unified_memory and recommendation == "hybrid":
